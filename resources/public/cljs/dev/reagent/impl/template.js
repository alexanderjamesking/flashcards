...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__20473__auto__,writer__20474__auto__,opt__20475__auto__){
return cljs.core._write.call(null,writer__20474__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__66977 = o;
(G__66977[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__66978__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__66978 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__66979__i = 0, G__66979__a = new Array(arguments.length -  0);
while (G__66979__i < G__66979__a.length) {G__66979__a[G__66979__i] = arguments[G__66979__i + 0]; ++G__66979__i;}
  args = new cljs.core.IndexedSeq(G__66979__a,0,null);
} 
return G__66978__delegate.call(this,args);};
G__66978.cljs$lang$maxFixedArity = 0;
G__66978.cljs$lang$applyTo = (function (arglist__66980){
var args = cljs.core.seq(arglist__66980);
return G__66978__delegate(args);
});
G__66978.cljs$core$IFn$_invoke$arity$variadic = G__66978__delegate;
return G__66978;
})()
;
} else {
...
if(cljs.core.truth_((function (){var and__19050__auto__ = !((jsprops == null));
if(and__19050__auto__){
var and__19050__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__66983 = jsprops;
(G__66983["defaultValue"] = value);

(G__66983["onChange"] = ((function (G__66983,v,value,on_change){
return (function (p1__66982_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__66982_SHARP_);
});})(G__66983,v,value,on_change))
);
...
var vec__66986 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__66986,(0),null);
var id = cljs.core.nth.call(null,vec__66986,(1),null);
var class$ = cljs.core.nth.call(null,vec__66986,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___66990 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___66990 == null)){
} else {
var key_66991 = temp__5461__auto___66990;
(jsprops["key"] = key_66991);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__66992 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__66992["name"] = c);
...
var len__21740__auto___66997 = arguments.length;
var i__21741__auto___66998 = (0);
while(true){
if((i__21741__auto___66998 < len__21740__auto___66997)){
args__21754__auto__.push((arguments[i__21741__auto___66998]));

var G__66999 = (i__21741__auto___66998 + (1));
i__21741__auto___66998 = G__66999;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__21755__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq66995){
var G__66996 = cljs.core.first.call(null,seq66995);
var seq66995__$1 = cljs.core.next.call(null,seq66995);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__66996,seq66995__$1);
});
...
break;
default:
var G__67002 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__67002;
continue;
...
var n__21262__auto___67004 = a.length;
var i_67005 = (0);
while(true){
if((i_67005 < n__21262__auto___67004)){
(a[i_67005] = reagent.impl.template.as_element.call(null,(a[i_67005])));

var G__67006 = (i_67005 + (1));
i_67005 = G__67006;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__21262__auto___67007 = a.length;
var i_67008 = (0);
while(true){
if((i_67008 < n__21262__auto___67007)){
var val_67009 = (a[i_67008]);
if((cljs.core.vector_QMARK_.call(null,val_67009)) && ((reagent.impl.template.key_from_vec.call(null,val_67009) == null))){
(o["no-key"] = true);
} else {
}

(a[i_67008] = reagent.impl.template.as_element.call(null,val_67009));

var G__67010 = (i_67008 + (1));
i_67008 = G__67010;
continue;
} else {
}
...
var ctx = ({});
var vec__67011 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__67011,(0),null);
var derefed = cljs.core.nth.call(null,vec__67011,(1),null);
...
var G__67014 = (cljs.core.count.call(null,argv) - first_child);
switch (G__67014) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__67014){
...
//# sourceMappingURL=template.js.map?rel=1518983340645
