...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__41187__auto__,writer__41188__auto__,opt__41189__auto__){
return cljs.core._write.call(null,writer__41188__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__68858 = o;
(G__68858[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__68859__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__68859 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__68860__i = 0, G__68860__a = new Array(arguments.length -  0);
while (G__68860__i < G__68860__a.length) {G__68860__a[G__68860__i] = arguments[G__68860__i + 0]; ++G__68860__i;}
  args = new cljs.core.IndexedSeq(G__68860__a,0,null);
} 
return G__68859__delegate.call(this,args);};
G__68859.cljs$lang$maxFixedArity = 0;
G__68859.cljs$lang$applyTo = (function (arglist__68861){
var args = cljs.core.seq(arglist__68861);
return G__68859__delegate(args);
});
G__68859.cljs$core$IFn$_invoke$arity$variadic = G__68859__delegate;
return G__68859;
})()
;
} else {
...
if(cljs.core.truth_((function (){var and__39620__auto__ = !((jsprops == null));
if(and__39620__auto__){
var and__39620__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__68864 = jsprops;
(G__68864["defaultValue"] = value);

(G__68864["onChange"] = ((function (G__68864,v,value,on_change){
return (function (p1__68863_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__68863_SHARP_);
});})(G__68864,v,value,on_change))
);
...
var vec__68867 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__68867,(0),null);
var id = cljs.core.nth.call(null,vec__68867,(1),null);
var class$ = cljs.core.nth.call(null,vec__68867,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___68871 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___68871 == null)){
} else {
var key_68872 = temp__5461__auto___68871;
(jsprops["key"] = key_68872);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__68873 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__68873["name"] = c);
...
var len__42174__auto___68878 = arguments.length;
var i__42175__auto___68879 = (0);
while(true){
if((i__42175__auto___68879 < len__42174__auto___68878)){
args__42181__auto__.push((arguments[i__42175__auto___68879]));

var G__68880 = (i__42175__auto___68879 + (1));
i__42175__auto___68879 = G__68880;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__42182__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq68876){
var G__68877 = cljs.core.first.call(null,seq68876);
var seq68876__$1 = cljs.core.next.call(null,seq68876);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__68877,seq68876__$1);
});
...
break;
default:
var G__68883 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__68883;
continue;
...
var n__41900__auto___68885 = a.length;
var i_68886 = (0);
while(true){
if((i_68886 < n__41900__auto___68885)){
(a[i_68886] = reagent.impl.template.as_element.call(null,(a[i_68886])));

var G__68887 = (i_68886 + (1));
i_68886 = G__68887;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__41900__auto___68888 = a.length;
var i_68889 = (0);
while(true){
if((i_68889 < n__41900__auto___68888)){
var val_68890 = (a[i_68889]);
if((cljs.core.vector_QMARK_.call(null,val_68890)) && ((reagent.impl.template.key_from_vec.call(null,val_68890) == null))){
(o["no-key"] = true);
} else {
}

(a[i_68889] = reagent.impl.template.as_element.call(null,val_68890));

var G__68891 = (i_68889 + (1));
i_68889 = G__68891;
continue;
} else {
}
...
var ctx = ({});
var vec__68892 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__68892,(0),null);
var derefed = cljs.core.nth.call(null,vec__68892,(1),null);
...
var G__68895 = (cljs.core.count.call(null,argv) - first_child);
switch (G__68895) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__68895){
...
//# sourceMappingURL=template.js.map?rel=1518985460023
