...
if((i < len)){
var k = (ks[i]);
var G__68818 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__68819 = (i + (1));
m = G__68818;
i = G__68819;
continue;
...
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__68821 = c;
var G__68821__$1 = (((G__68821 == null))?null:G__68821.prototype);
if((G__68821__$1 == null)){
return null;
} else {
return (G__68821__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_.call(null,c)) && (!(((function (){var G__68823 = c;
var G__68823__$1 = (((G__68823 == null))?null:G__68823.prototype);
if((G__68823__$1 == null)){
return null;
} else {
return (G__68823__$1["render"]);
}
})() == null)));
});
...
return (function() { 
var G__68826__delegate = function (args){
return reagent.impl.component.as_element.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__68826 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__68827__i = 0, G__68827__a = new Array(arguments.length -  0);
while (G__68827__i < G__68827__a.length) {G__68827__a[G__68827__i] = arguments[G__68827__i + 0]; ++G__68827__i;}
  args = new cljs.core.IndexedSeq(G__68827__a,0,null);
} 
return G__68826__delegate.call(this,args);};
G__68826.cljs$lang$maxFixedArity = 0;
G__68826.cljs$lang$applyTo = (function (arglist__68828){
var args = cljs.core.seq(arglist__68828);
return G__68826__delegate(args);
});
G__68826.cljs$core$IFn$_invoke$arity$variadic = G__68826__delegate;
return G__68826;
})()
;})(c,f,_,res))
:res);
...
var _STAR_current_component_STAR_68830 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_68830;
}});
...
var G__68831 = key;
var G__68831__$1 = (((G__68831 instanceof cljs.core.Keyword))?G__68831.fqn:null);
switch (G__68831__$1) {
...
return ((function (G__68831,G__68831__$1){
...
var or__39642__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__68832_68834 = (c["cljsRatom"]);
if((G__68832_68834 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__68832_68834);
}
...
if(cljs.core.truth_((function (){var and__39620__auto__ = wrap;
...
var renders_68836 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_68837 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_68836));
if((cljs.core.count.call(null,renders_68836) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_68836))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_68837)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_68837))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__39642__auto__ = new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__39642__auto__)){
return or__39642__auto__;
} else {
...
var render_fun__$1 = (function (){var or__39642__auto__ = render_fun;
if(cljs.core.truth_(or__39642__auto__)){
return or__39642__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__39642__auto__ = new cljs.core.Keyword(null,"displayName","displayName",-809144601).cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__39642__auto__)){
return or__39642__auto__;
} else {
...
var name__$1 = (function (){var G__68835 = name;
switch (G__68835) {
case "":
...
var G__68839 = o;
(G__68839[cljs.core.name.call(null,k)] = v);
...
var elem = (function (){var G__68840 = (function (){var or__39642__auto__ = (function (){var G__68842 = c;
if((G__68842 == null)){
return null;
} else {
return (G__68842["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__39642__auto__)){
return or__39642__auto__;
...
return (G__68840["_currentElement"]);
}
})();
var name = (function (){var G__68843 = elem;
var G__68843__$1 = (((G__68843 == null))?null:(G__68843["type"]));
if((G__68843__$1 == null)){
return null;
} else {
return (G__68843__$1["displayName"]);
}
})();
var path = (function (){var G__68844 = elem;
var G__68844__$1 = (((G__68844 == null))?null:(G__68844["_owner"]));
var G__68844__$2 = (((G__68844__$1 == null))?null:reagent.impl.component.component_path.call(null,G__68844__$1));
if((G__68844__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68844__$2)," > "].join('');
}
})();
...
var n = (function (){var or__39642__auto__ = reagent.impl.component.component_path.call(null,c);
if(cljs.core.truth_(or__39642__auto__)){
return or__39642__auto__;
} else {
var G__68845 = c;
var G__68845__$1 = (((G__68845 == null))?null:G__68845.constructor);
if((G__68845__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__68845__$1);
}
}
})();
...
//# sourceMappingURL=component.js.map?rel=1518985459773
