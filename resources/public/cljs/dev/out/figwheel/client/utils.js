...
return (new CustomEvent(event_name,(function (){var obj78647 = {"detail":data};
return obj78647;
})()));
} else {
...
var f = (function (){var pred__78654 = cljs.core._EQ_;
var expr__78655 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__78654.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__78655))){
return ((function (pred__78654,expr__78655){
return (function (p1__78648_SHARP_){
return console.warn(p1__78648_SHARP_);
});
;})(pred__78654,expr__78655))
} else {
if(cljs.core.truth_(pred__78654.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__78655))){
return ((function (pred__78654,expr__78655){
return (function (p1__78649_SHARP_){
return console.debug(p1__78649_SHARP_);
});
;})(pred__78654,expr__78655))
} else {
if(cljs.core.truth_(pred__78654.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__78655))){
return ((function (pred__78654,expr__78655){
return (function (p1__78650_SHARP_){
return console.error(p1__78650_SHARP_);
});
;})(pred__78654,expr__78655))
} else {
return ((function (pred__78654,expr__78655){
return (function (p1__78651_SHARP_){
return console.log(p1__78651_SHARP_);
});
;})(pred__78654,expr__78655))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__78658){
var map__78659 = p__78658;
var map__78659__$1 = ((((!((map__78659 == null)))?((((map__78659.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78659.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__78659):map__78659);
var opts = map__78659__$1;
var eval_fn = cljs.core.get.call(null,map__78659__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__78661_SHARP_){
return new_def.callback(p1__78661_SHARP_);
});})(new_def))
);
...
return (function (p__78662){
var vec__78663 = p__78662;
var ky = cljs.core.nth.call(null,vec__78663,(0),null);
var v = cljs.core.nth.call(null,vec__78663,(1),null);
...
}catch (e78668){if((e78668 instanceof Error)){
var e = e78668;
return not_found;
} else {
throw e78668;
...
//# sourceMappingURL=utils.js.map?rel=1519023125638
